...
<ol class="breadcrumb">
  ...
  <h6 class="display-4">Congratulations !! Your answer is correct</h6><hr>
<h5> Drag and Drop the Correct Answers</h5>
<br>
    
    <p style="font-size: 22px ;"><input type="text" value="ng" style="color:#45B662"> <input type="text" value="new" style="color:#45B662"> testapp. <img src="correct.png" width="50px" height="50px"> </p>
    <br>
    <br>
...
<div class="card border-light mb-3" style="max-width: 30rem;">
 ...
 <div align="right">
<button type="button" class="btn btn-success" style="align-content: right">Continue Next Lesson</button>
</div>   
</div> 
